...
import { INTERNAL_DIRECT_CHANNEL_NAME, INTERNAL_CHANNEL_NAME, MODULE_FIELD_NAME } from "@/Constants";
import { ComponentConfigBuilder, ComponentConfig, ComponentConfigImpl } from "@/ComponentConfig";
