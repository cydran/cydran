...
export interface LevelStrategy extends IflevelStrategy, IsLevelType {
	 ...
	 */
	trace(logLabel: string, appenders: Appender[], msgBase: string, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	debug(logLabel: string, appenders: Appender[], msgBase: string, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	info(logLabel: string, appenders: Appender[], msgBase: string, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	warn(logLabel: string, appenders: Appender[], msgBase: string, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	error(logLabel: string, appenders: Appender[], msgBase: string, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	fatal(logLabel: string, appenders: Appender[], msgBase: string, ...moreArgs: any[]): void;
