...
export interface IflevelStrategy {
	 ...
	 */
	ifTrace(logName: string, pender: Appender, payloadFn: () => any, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	ifDebug(logName: string, pender: Appender, payloadFn: () => any, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	ifInfo(logName: string, pender: Appender, payloadFn: () => any, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	ifWarn(logName: string, pender: Appender, payloadFn: () => any, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	ifError(logName: string, pender: Appender, payloadFn: () => any, ...moreArgs: any[]): void;
	 ...
	 * @param moreArgs additional optional arguments; the last argument as an Error is assumed to be required for the stack ouptut regardless of log level
	 */
	ifFatal(logName: string, pender: Appender, payloadFn: () => any, ...moreArgs: any[]): void;
