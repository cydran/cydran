...
class CheckDependenciesTask extends AbstractTask<any> {
	...
	public async execute(): Promise<void> {
		...
		const ARRAY_OF_FILES_AND_DIRS_TO_CRUISE: string[] = [srcPath, testPath];

		// TODO - Explore options of moving this into a JSON file
...
export default CheckDependenciesTask;
